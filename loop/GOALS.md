...
- [x] p4-2: ADC (asymmetric distance computation) — query vs PQ codes
      depends_on: p4-1
...
- [x] p4-3: drift detection — alignment score + enqueue retrain (never inline)
      depends_on: p4-1
...
- [x] p4-4: integrate PQ into segment + P4 gate (recall@10 overlap >96% vs float32)
