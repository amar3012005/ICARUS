...
Last updated after the independently verified CLI release **0.3.62**. Its macOS ARM64 artifact
was freshly downloaded in bounded resumable segments, SHA-256 checked against its release sidecar,
executed as `0.3.62`, and verified against both GitHub provenance and SPDX SBOM attestations.
