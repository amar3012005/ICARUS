...
const { startTask, transitionTask, authorizeAction, authorizeAdapterWrite, recordAdapterLifecycle, __setNativeHarnessBridgeForTest } = require('../../harness.js');
...
test('task lifecycle commands transport values to the Rust authority unchanged', () => {
  ...
  assert.deepEqual(calls[4], ['lifecycle', '/repo', 'TASK-ABCDEFGHIJKL', 'adapter_session_ended', 0]);
});
