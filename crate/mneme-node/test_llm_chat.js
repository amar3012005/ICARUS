...
assert.match(request.messages[0].content, /I don't know from my local memory yet/i);
...
assert.match(request.messages[0].content, /first-person voice/i);
assert.match(request.messages[0].content, /my read is/i);
